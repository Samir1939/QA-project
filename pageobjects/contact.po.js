...
exports.ContactPage=class ContactPage{
    ...
    async validateContactCreated(fName,lName,dob,email,phone,address,city,state,postal,country){
       ...
       const fNameValidation= this.page.locator(this.savedFirstName);
       const lNameValidation= this.page.locator(this.savedLastName);
       const dobValidation= this.page.locator(this.savedDOB);
       const emailValidation= this.page.locator(this.savedEmail);
       const phoneValidation= this.page.locator(this.savedPhone);
       const addressValidation= this.page.locator(this.savedAddress);
       const cityValidation= this.page.locator(this.savedCity);
       const stateValidation= this.page.locator(this.savedState);
       const postalValidation= this.page.locator(this.savedPostal);
       const countryValidation= this.page.locator(this.savedCountry);
